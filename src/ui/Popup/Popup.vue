        ...
        <div :class="$style.popup">
          <div ref="contentRef" :class="$style.content">
            <div :class="$style.content__rest">
              <p v-if="message" v-html="message" :class="$style.message" />
...
import { inject, onBeforeUnmount, ref, toRefs, watch } from 'vue';

import { POPUPS_HOST_TOKEN } from '@/tokens';
...
const { modelValue, message } = toRefs(props);
